...
import { FileText, Users, TrendingUp, ShoppingBag, Package, Receipt, Plus, Eye, BarChart3, MessageSquare, FolderOpen, Megaphone, Clock, DollarSign, Activity, ArrowUpRight, ArrowDownRight, RefreshCw } from "lucide-react";
            ...
            {recentOrders.length === 0 ? (
              ...
              <div className="space-y-3">
                {recentOrders.map((order) => (
                  <div key={order.id} className="flex items-center justify-between p-2 md:p-3 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
            ...
            {recentRequests.length === 0 ? (
              ...
              <div className="space-y-3">
                {recentRequests.map((request) => (
                  <div key={request.id} className="flex items-center justify-between p-2 md:p-3 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
                    <div className="flex-1 min-w-0">
